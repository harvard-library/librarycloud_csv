...
<xsl:stylesheet version="2.0" xmlns:xlink="http://www.w3.org/1999/xlink"
	...
	<xsl:template match="alephRecs">
		<!--<xsl:text>"HOLLIS #","Title","Type","PlaceCode","PubPlace","Publisher","SingleDate","DateEnd","DateStart","Name","NameRole","NameDates","URI"</xsl:text>-->
		<xsl:apply-templates/>
	</xsl:template>
	...
	<xsl:template match="viaRecs">
		<!--<xsl:text>"VIA #","Title","Type","PlaceName","DateCreated","Name","NameRole","NameDates","URI","RelatedItem","Relationship"</xsl:text>-->
		<xsl:apply-templates/>
	</xsl:template>
	...
	<xsl:template match="oasisRecs">
		<!--<xsl:text>"Item - OASIS #","Item - Title","Item - DateCreated","Collection - Title","Collection - Name","Collection - Date","Collection - OASIS #","URI"</xsl:text>-->
		<xsl:apply-templates/>
	</xsl:template>
